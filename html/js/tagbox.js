(function ($) {
    ...
    $.fn.tagbox = function(options) {
        ...
        theTypeTarget.attr("placeholder", "단어 입력 후 엔터키를 입력하세요");
    ...
    function insertTagElement(text) {
        ...
        theTypeTarget.val("").css("width", "99%");
    ...
    function buildTagHtmlString(text) {
        var tag_str = "<div class='tag_element'><a href='#' title='remove' class='tag_dismiss'><span class='tag_label'>" + text +
            "</span></a></div>";
        return tag_str;
    }
    ...
    function buildExampleTagElement() {
        var tagStr = '<div class="tag_element"></div>';
        return tagStr;
    }
