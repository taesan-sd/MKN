...
require_once "../excel/PHPExcel-1.8/Classes/PHPExcel.php"; // PHPExcel.php을 불러와야 하며, 경로는 사용자의 설정에 맞게 수정해야 한다.
require_once "../excel/PHPExcel-1.8/Classes/PHPExcel/IOFactory.php"; // IOFactory.php을 불러와야 하며, 경로는 사용자의 설정에 맞게 수정해야 한다.
...
if($_FILES['upFile']['tmp_name']) {
	...
	try { // 업로드 된 엑셀 형식에 맞는 Reader객체를 만든다.
		...
		$sql = " truncate table $table ";	// db 초기화
